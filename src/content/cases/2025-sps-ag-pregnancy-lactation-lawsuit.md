...
# === IDENTITY ===
id: SPS-2025-005
title: "Seattle Public Schools — WA AG civil rights lawsuit over pregnancy and lactation accommodations"
slug: sps-ag-pregnancy-lactation-lawsuit
date_surfaced: 2025-04-15
...
actors:
  ...
  - name: Washington State Attorney General's Office
    role_type: agency
    title: Plaintiff (civil rights enforcement)
    party: null
    jurisdiction: Washington State
  - name: Nick Brown
    role_type: elected
    title: Washington State Attorney General (sworn in January 15, 2025, succeeding Bob Ferguson)
    party: D
    jurisdiction: Washington State
...
severity_type:
  - structural_failure
reforms_implicated:
  - employer_civil_rights_compliance
  - pregnancy_accommodation_policy
  - retaliation_protections

# === SCALE ===
dollars_at_issue: null
dollars_basis: "Restitution sought for affected employees; specific amount to be determined by court. Affected class size not stated in press release."
...
sources:
  - tier: 1
    ...
    title: "Attorney General's Office sues Seattle Public Schools over illegal treatment of pregnant and nursing employees"
  ...
  - tier: 1
    type: agency_statement
    title: "SPS Policy 5010SP.B — Workplace Accommodations for Pregnancy and Nursing"
...
# === REFORM LINKAGE ===
reform_argument: |
  The AG's complaint documents two structural failures. First, Seattle
  Public Schools had no district-level policy for handling pregnancy
  accommodation requests from employees — an absence of governance
  infrastructure rather than a misapplication of existing rules. Employees
  were denied flexible restroom breaks, modified work schedules, and the
  ability to sit during shifts; nursing employees were provided no
  clean, private pumping spaces, with documented physical consequences
  including clogged ducts and mastitis. Second, the AG alleges retaliation
  against employees who requested accommodations: negative performance
  reviews, admonishments for medical appointments, removal from preferred
  classroom assignments, and in some cases periods unpaid or without
  benefits. Three reforms map here: (1) employer civil-rights compliance
  audits as a routine board-level oversight item, not a reactive measure;
  (2) baseline written policy for any accommodation category established
  by state statute, with audit trails for requests and responses; (3)
  explicit retaliation protections enforced through HR with reporting
  pathways that do not route through the supervisor who is the alleged
  source of the retaliation. See [reform: employer_civil_rights_compliance],
  [reform: pregnancy_accommodation_policy],
  [reform: retaliation_protections].
...
- King County Superior Court case number not yet retrieved; complaint PDF was inaccessible at the time of intake research.
- Specific schools named in the complaint not yet identified (the AG press release referenced "various schools" without naming them).
- Number of employees in the affected class not stated publicly.
- Whether SPS Policy 5010SP.B (November 2025) satisfies the AG's demands has not been publicly determined.

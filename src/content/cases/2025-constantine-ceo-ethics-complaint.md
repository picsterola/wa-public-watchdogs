...
# === IDENTITY ===
id: KC-2025-008
title: "Constantine Sound Transit CEO selection ethics complaint — dismissed by King County Ombuds"
...
actors:
  - name: Dow Constantine
    ...
    title: CEO, Sound Transit (former King County Executive, former ST Board member)
    party: D
...
# === SCALE ===
dollars_at_issue: 450000
dollars_basis: "Constantine CEO base salary at Sound Transit: $450,000 at hire (per Fox 13 Seattle and Seattle Times; later raised to $474,276 effective January 2026). The ethics complaint did not allege a specific dollar misappropriation; the underlying concern was the structural overlap between Constantine's prior role as King County Executive (appointing ~10 of 18 ST board members) and his candidacy for the CEO position those appointees would select. The $675K figure that circulated in early coverage was a ceiling estimate on a Krauthamer recruiting invoice, not the actual contracted salary."
...
sources:
  - tier: 1
    ...
    title: "King County Ombuds Ethics Report OMB-2025-0160 — dismissal of complaint against Dow Constantine"
    publisher: King County Office of the Ombuds
    date: 2025-06-18
    url: https://cdn.kingcounty.gov/-/media/king-county/independent/governance-and-leadership/government-oversight/office-of-the-ombuds/reports/omb-2025-0160_ethics_report.pdf
    archive_url: null
  - tier: 2
    type: news
    title: "Sound Transit hires Constantine as CEO"
...
# === REFORM LINKAGE ===
reform_argument: |
  The Ombuds' dismissal turned on a narrow reading: Constantine did not
  formally evaluate himself, and the existing King County Ethics Code does
  not address structural conflicts between an executive's appointment power
  and subsequent candidacy for positions filled by those appointees. The
  Ombuds finding is the system working as designed under the existing rule.
  The structural reform question is whether the King County Ethics Code
  should be amended to include cooling-off or recusal provisions when an
  appointing official becomes a candidate for a position selected by their
  appointees. This is the same governance gap surfaced in KC-2025-005 from
  a different angle: the underlying appointment-pattern structural concern
  is real even though the specific ethics complaint was dismissed.

...
[Disability Rights Washington](https://disabilityrightswa.org/cases/trueblood/), the class counsel, summarizes the case and its current status on its case page. Judge Pechman's July 2023 ruling is the operative primary document; the [Seattle Times](https://www.seattletimes.com/seattle-news/mental-health/federal-judge-fines-wa-agency-100-million-for-mental-health-failures/) quoted it at length on the ruling date: *"The Court is unpersuaded that DSHS adequately planned for and took reasonable measures to address the bed shortage."*

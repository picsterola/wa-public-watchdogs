...
title: >-
  Commerce Digital Navigator Program — SAO performance audit finds $92.5M
...
dollars_basis: >-
  $92.5 million total program budget for the Digital Navigator Program,
  FY2022–FY2025, representing 38% of the $242.7 million Commerce received for
  digital navigation and broadband access programs. SAO found the agency could
  not verify as allowable almost all of the $10.7 million paid to a single
  primary grantee (Equity in Education Center) because documentation was
  insufficient. Commerce paused further payments to EEC in February 2025 after
  new administration leadership identified the documentation gap. Agency
  executives bypassed state procurement rules; a program staff member took
  employment with a grantee, a potential state ethics violation referred to the
  State Ethics Board. Program was shut down June 30, 2025. Dollars_at_issue
  reflects total program budget; dollars_confirmed_loss is null pending CPA
  review and State Ethics Board resolution.
dollars_confirmed_loss: null
legal_status: audit_finding
outcome_summary: >-
  SAO performance audit (ARN 1038954) published January 27, 2026 found Commerce
  failed at nearly every stage of grant oversight for the Digital Navigator
  Program. Key findings: did not use competitive processes to award or expand
  grants; did not adequately vet grantees or subgrantees; contracts lacked clear
  deliverables and compliance requirements; did not effectively manage or
  monitor grantee performance; agency executives ignored state rules and
  managers' concerns; approximately $10.7 million paid to one primary grantee
  (Equity in Education Center) without sufficient documentation; a staff
  member's employment with a grantee referred to the State Ethics Board.
  Commerce paused payments to EEC in February 2025; program ended June 30, 2025.
  Ferguson administration appointed new Commerce leadership; State Auditor noted
  she was 'heartened by the commitment to accountability shown by the agency's
  new leadership.'
sources:
  - tier: 1
    type: sao_report
  ...
  - tier: 1
    ...
    quote: >-
      ...
      immediately paused further payments.
  - tier: 2
    type: news
    title: >-
      State Audit Finds Commerce Department Mishandled $92 Million Digital
...
reform_argument: >
  ...
  relief case (WA-2024-COMMERCE-COVID) — same agency, same
  ...
  — and the same audit mechanism: SAO finds the problem after the money has
  moved.
  ...
  Reform argument: federal-grant oversight at state agencies requires
  independent
...
remediation_note: >-
  Program shut down June 2025; new Commerce leadership issued April 2026 risk
  memo; ethics referral made; no independent follow-up audit yet (expected
  summer 2026).
reform_status_note: >-
  Reform is executive action by new Commerce leadership; no legislation filed
  targeting these audit findings.
next_milestone: SAO accountability audit follow-up (Commerce grant controls)

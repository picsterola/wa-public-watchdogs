...
actors:
  ...
  - name: Alex Thornewell
    role_type: nonprofit
    title: 'Plaintiff, former Garfield High School varsity swim team member'
    party: null
    jurisdiction: King County
  - name: Carole Lynch
    role_type: bureaucrat
    title: >-
      Athletic Director, Garfield High School (initiated 2019-2020 hazing
      investigation)
    party: null
    jurisdiction: King County
...
severity_type:
  ...
  - special_privileges
reforms_implicated:
  - first_amendment_protections_for_students
  - hazing_response_protocols
  - disability_inclusive_investigations
dollars_at_issue: 125000
dollars_basis: >-
  $125,000 civil settlement reached by May 9, 2024 in King County Superior Court
  case AT v. Seattle School District No. 1 (Case No. 22-2-10907-6 SEA). SPS did
  not admit wrongdoing.
dollars_confirmed_loss: 125000
legal_status: settled
outcome_summary: >-
  Settled May 9, 2024 for $125,000. SPS did not admit wrongdoing. A parallel
  Public Records Act case brought by the plaintiff's mother (Amanda Thornewell
...
sources:
  ...
  - tier: 2
    ...
    archive_url: >-
      https://web.archive.org/web/20260522222818/https://www.kiro7.com/news/local/former-seattle-student-wins-settlement-against-sps/JERFW36DTBCAVKYDHCHVYKZ7CI/
  - tier: 2
    type: news
    title: >-
...
reform_argument: |
  The case documents a sequence in which a student who witnessed locker-room
  hazing and attempted to speak to a school newspaper reporter was
  administratively silenced by a vice principal, then had his autism
  invoked by the district's own investigator as a basis for asking
  witnesses if he was prone to "exaggerate or fabricate details." Three
  reforms map to this: (1) explicit First Amendment protections for
  student speech to student journalists, with consequences for
  administrative interference; (2) hazing-response protocols that do not
  rely on the building principal or vice principal of the school where
  the conduct occurred; (3) investigation protocols that do not allow a
  witness's disability to be used as a credibility attack absent specific
  evaluative authority. See [reform: first_amendment_protections_for_students],
  [reform: hazing_response_protocols],
  [reform: disability_inclusive_investigations].
